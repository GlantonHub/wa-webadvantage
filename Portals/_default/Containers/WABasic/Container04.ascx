...
<div class="Gray04_style">
  <div class="Gray04_top_bg">
    <div class="c_icon">
    ...
    <div class="Gray04_c_menu">
      <dnn:ACTIONS runat="server" id="dnnACTIONS"  ProviderName="DNNMenuNavigationProvider" ExpandDepth="1" PopulateNodesFromClient="True" />
    </div>
    <div class="Gray04_c_help">
      <dnn:ACTIONBUTTON runat="server" id="dnnACTIONBUTTON5" CommandName="ModuleHelp.Action" DisplayIcon="True" DisplayLink="False" />
    </div>
			 <div class="Gray04_top_shadow"><div class="Gray04_top_icon"></div></div>
    <div class="clear_float"></div>
  </div>
  <div class="c_content_style">
    <div id="ContentPane" runat="server" class="Gray04_content"></div>
  </div>
  <div class="c_footer">
