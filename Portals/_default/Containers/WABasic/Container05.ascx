...
<div class="Gray05_style">
  <div class="Gray05_top_bg">
    <div class="c_icon">
    ...
    <div class="Gray05_c_menu">
      <dnn:ACTIONS runat="server" id="dnnACTIONS"  ProviderName="DNNMenuNavigationProvider" ExpandDepth="1" PopulateNodesFromClient="True" />
    </div>
    <div class="Gray05_c_help">
  ...
  <div class="c_content_style">
    <div id="ContentPane" runat="server" class="Gray05_content"></div>
  </div>
  <div class="c_footer">
