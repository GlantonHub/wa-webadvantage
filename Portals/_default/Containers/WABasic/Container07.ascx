...
<div class="Gray07_style">
  <div class="Gray07_top_bg">
    <div class="c_icon">
    ...
    <div class="Gray07_c_menu">
      <dnn:ACTIONS runat="server" id="dnnACTIONS"  ProviderName="DNNMenuNavigationProvider" ExpandDepth="1" PopulateNodesFromClient="True" />
    </div>
    <div class="Gray07_c_help">
  ...
  <div class="c_content_style">
    <div id="ContentPane" runat="server" class="Gray07_content"></div>
  </div>
  <div class="c_footer">
