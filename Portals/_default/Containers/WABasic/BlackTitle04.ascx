...
<div class="BlackTitle04_style">
  <div class="BlackTitle04_top_bg">
    <div class="c_icon">
      <dnn:ICON runat="server" id="dnnICON" />
	</div>
    <div class="c_title">
      <h2 class="c_titles"><dnn:TITLE runat="server" id="dnnTITLE"  CssClass="c_title_black" /></h2>
	</div>
    <div class="BlackTitle04_c_menu">
      <dnn:ACTIONS runat="server" id="dnnACTIONS"  ProviderName="DNNMenuNavigationProvider" ExpandDepth="1" PopulateNodesFromClient="True" />
    </div>
    <div class="BlackTitle04_c_help">
  ...
  <div class="c_content_style">
    <div id="ContentPane" runat="server" class="BlackTitle04_content"></div>
  </div>
  <div class="c_footer">
  ...
  <div class="BlackTitle04_footer"></div>
</div>