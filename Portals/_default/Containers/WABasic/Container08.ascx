...
<div class="Gray08_style">
  <div class="Gray08_top_bg">
    <div class="c_icon">
    ...
    <div class="Gray08_c_menu">
      <dnn:ACTIONS runat="server" id="dnnACTIONS"  ProviderName="DNNMenuNavigationProvider" ExpandDepth="1" PopulateNodesFromClient="True" />
    </div>
    <div class="Gray08_c_help">
  ...
  <div class="c_content_style">
    <div id="ContentPane" runat="server" class="Gray08_content"></div>
  </div>
  <div class="c_footer">
