    ...
    <div class="skin_width">
      <div class="LM_main_content clearafter">
        <section class="LM_position">
          <dnn:MENU MenuStyle="LeftMenu" runat="server"></dnn:MENU>
          <div></div>
          <div class="leftside_style">
            <div id="LeftSidePane" runat="server" class="leftsidepane"></div>
          </div>
        </section>
        <section class="LM_skin_content">
          ...
          <div class="row dnnpane">
            <div runat="server" id="OneGrid8" class="l_one_grid8 col-sm-8"></div>
            <div runat="server" id="OneGrid4" class="l_one_grid4 col-sm-4"></div>
          </div>
          <div class="row dnnpane">
            <div runat="server" id="TwoGrid6A" class="l_two_grid6a col-sm-6"></div>
            <div runat="server" id="TwoGrid6B" class="l_two_grid6b col-sm-6"></div>
          </div>
          <div class="row dnnpane">
            <div runat="server" id="ThreeGrid4" class="l_three_grid4 col-sm-4"></div>
            <div runat="server" id="ThreeGrid8" class="l_three_grid8 col-sm-8"></div>
          </div>
          <div class="row dnnpane">
            <div runat="server" id="FourGrid4A" class="l_four_grid4a col-sm-4"></div>
            <div runat="server" id="FourGrid4B" class="l_four_grid4b col-sm-4"></div>
            <div runat="server" id="FourGrid4C" class="l_four_grid4c col-sm-4"></div>
          </div>
          <div class="row dnnpane">
            <div runat="server" id="FiveGrid12" class="l_five_grid12 col-sm-12"></div>
          </div>
        </section>
      </div>
    </div>
